                      ...
                      <tr style="margin: 0; padding: 0;">
                        <td align="center" style="border-collapse: collapse; border-spacing: 0; padding: 50px;">
                          ...
                          <div style="margin-bottom: 30px; text-align: left;" align="left">
                            <a href="http://link.indiegogo.com/click/57221e226e4adcdb6f8b5c08/aHR0cHM6Ly93d3cuaW5kaWVnb2dvLmNvbS8/57221e21fc2383c94d8b4585B04802c66" utm_content="igg-header-logo" utm_medium="email" style="color: #eb1478; text-decoration: none;">
                              <img alt="" class="logo" src="https://apuestatotal.com/img/logo.png?201901291231" style="display: block; border: none;" width="125">
                            </a>
                          </div>

                          <p style="font-size: 22px; line-height: 22px; margin: 0; padding: 0;">{{$nombre}},</p>

                          <div style="text-align: left;" align="left">
                            <p style="font-size: 20px; line-height: 28px; margin: 20px 0 0; padding: 0;">
                            Gracias por inscribirte en el sorteo. Por favor confirma tu dirección de correo electrónico y registra tus tickets presionando el siguiente botón.                              
                            </p>                            
                          </div>

                          <p style="font-size: 20px; line-height: 22px; margin: 0; padding: 0;">
                            <a href={{$ruta}} style="margin-top: 40px; color: #ffffff; text-decoration: none; display: inline-block; font-family: sans-serif; font-size: 20px; line-height: 46px; text-align: center; -webkit-text-size-adjust: none; font-weight: bold; white-space: nowrap; text-transform: uppercase; background-color: #00000F; padding: 5px 50px;">Confirmar y Registrar</a>
                          </p>
